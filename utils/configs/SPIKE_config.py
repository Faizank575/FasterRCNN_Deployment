...
# data set config
__C.DATA.DATASET = "SPIKE"
__C.DATA.MAP_FILE_PATH = "../../DataSets/SPIKE"
...
__C.roi_min_side_rel = 0.04   #0.04
# maximum relative width/height of an ROI
__C.roi_max_side_rel = 0.4   #0.4
...
__C.roi_max_aspect_ratio = 4.0    #4.0
